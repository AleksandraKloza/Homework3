...
```{r} plot <- ggplot(stroop_model, aes(x = condition, y = rt)) + geom_point() + stat_smooth(method = "lm", col = "red") + ylab("Reaction time intercept") + xlab("Condition") ```

```{r, echo=TRUE} print(plot) ```
